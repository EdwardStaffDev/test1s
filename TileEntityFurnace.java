...
public class TileEntityFurnace extends TileEntity implements ISidedInventory
{
    ...
    private boolean func_145948_k()
    {
        ...
        else
        {
            ...
            return var1 == null ? false : (this.field_145957_n[2] == null ? true : (!this.field_145957_n[2].isItemEqual(var1) ? false : (this.field_145957_n[2].stackSize < this.getLastActiveItemsStackLimit() && this.field_145957_n[2].stackSize < this.field_145957_n[2].getMaxStackSize() ? true : this.field_145957_n[2].stackSize < var1.getMaxStackSize())));
        }
    }
