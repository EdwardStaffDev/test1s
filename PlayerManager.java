...
public class PlayerManager
{
    ...
    public void filterChunkLoadQueue(EntityPlayerMP p_72691_1_)
    {
        ...
        int var7 = 0;
        int var8 = 0;
        ChunkCoordIntPair var9 = this.getOrCreateChunkWatcher(var5, var6, true).currentChunkLocation;
        ...
        for (var10 = 1; var10 <= var4 * 2; ++var10)
        {
            for (int var11 = 0; var11 < 2; ++var11)
            {
                ...
                for (int var13 = 0; var13 < var10; ++var13)
                {
                    var7 += var12[0];
                    var8 += var12[1];
                    var9 = this.getOrCreateChunkWatcher(var5 + var7, var6 + var8, true).currentChunkLocation;
    ...
    public boolean isPlayerWatchingChunk(EntityPlayerMP p_72694_1_, int p_72694_2_, int p_72694_3_)
    {
        ...
        return var4 != null && var4.playersWatchingChunk.contains(p_72694_1_) && !p_72694_1_.loadedChunks.contains(var4.currentChunkLocation);
    }
    ...
    class PlayerInstance
    {
        ...
        private final ChunkCoordIntPair currentChunkLocation;
        ...
        {
            this.currentChunkLocation = new ChunkCoordIntPair(p_i1518_2_, p_i1518_3_);
        ...
        public void addPlayer(EntityPlayerMP p_73255_1_)
        {
            ...
            {
                PlayerManager.field_152627_a.debug("Failed to add player. {} already is in chunk {}, {}", new Object[] {p_73255_1_, Integer.valueOf(this.currentChunkLocation.chunkXPos), Integer.valueOf(this.currentChunkLocation.chunkZPos)});
            }
            else
            {
                ...
                p_73255_1_.loadedChunks.add(this.currentChunkLocation);
            }
        }
        ...
        public void removePlayer(EntityPlayerMP p_73252_1_)
        {
            ...
            {
                Chunk var2 = PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.currentChunkLocation.chunkXPos, this.currentChunkLocation.chunkZPos);
                ...
                p_73252_1_.loadedChunks.remove(this.currentChunkLocation);

                if (this.playersWatchingChunk.isEmpty())
                {
                    long var3 = (long)this.currentChunkLocation.chunkXPos + 2147483647L | (long)this.currentChunkLocation.chunkZPos + 2147483647L << 32;
                    ...
                    PlayerManager.this.getWorldServer().theChunkProviderServer.unloadChunksIfNotNearSpawn(this.currentChunkLocation.chunkXPos, this.currentChunkLocation.chunkZPos);
                }
            }
        }
        ...
        {
            this.increaseInhabitedTime(PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.currentChunkLocation.chunkXPos, this.currentChunkLocation.chunkZPos));
        }
        ...
        public void func_151251_a(Packet p_151251_1_)
        {
            for (int var2 = 0; var2 < this.playersWatchingChunk.size(); ++var2)
            {
                ...
                if (!var3.loadedChunks.contains(this.currentChunkLocation))
                {
        ...
        public void sendChunkUpdate()
        {
            if (this.numberOfTilesToUpdate != 0)
            {
                ...
                {
                    var1 = this.currentChunkLocation.chunkXPos * 16 + (this.field_151254_d[0] >> 12 & 15);
                    var2 = this.field_151254_d[0] & 255;
                    var3 = this.currentChunkLocation.chunkZPos * 16 + (this.field_151254_d[0] >> 8 & 15);
                ...
                else
                {
                    ...
                    if (this.numberOfTilesToUpdate == 64)
                    {
                        var1 = this.currentChunkLocation.chunkXPos * 16;
                        var2 = this.currentChunkLocation.chunkZPos * 16;
                        this.func_151251_a(new S21PacketChunkData(PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.currentChunkLocation.chunkXPos, this.currentChunkLocation.chunkZPos), false, this.flagsYAreasToUpdate));
                    ...
                    {
                        this.func_151251_a(new S22PacketMultiBlockChange(this.numberOfTilesToUpdate, this.field_151254_d, PlayerManager.this.theWorldServer.getChunkFromChunkCoords(this.currentChunkLocation.chunkXPos, this.currentChunkLocation.chunkZPos)));

                        for (var1 = 0; var1 < this.numberOfTilesToUpdate; ++var1)
                        {
                            var2 = this.currentChunkLocation.chunkXPos * 16 + (this.field_151254_d[var1] >> 12 & 15);
                            var3 = this.field_151254_d[var1] & 255;
                            var4 = this.currentChunkLocation.chunkZPos * 16 + (this.field_151254_d[var1] >> 8 & 15);
